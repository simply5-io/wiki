...
const features2 = [

    {
        ...
        href: "docs/cloudlan/getting_started/whats_new",
    }, {
        title: "FAQ's",
        imageUrl: 'img/undraw_Faq_re_31cw.svg',
        href: "docs/cloudlan/help_support/support/product_queries",
    },
    {
        title: "Troubleshooting",
        imageUrl: 'img/undraw_bug_fixing_oc7a.svg',
        href: "docs/cloudlan/help_support/troubleshooting",
    },
    {
        title: "CloudLAN Free Room",
        imageUrl: 'img/undraw_features_overview_jg7a.svg',
        href: "docs/cloudlan/getting_started/setup_cloudlan_room#cloudlan-free-room",
    },
    {
        title: "Invite & Join Room",
        imageUrl: 'img/undraw_join_of2w.svg',
        href: "/docs/cloudlan/introduction/#invite--join-room",
    },

    {
        title: 'Service Casting',
        imageUrl: 'img/undraw_real-time_sync_o57k.svg',
        href: "docs/cloudlan/getting_started/service_cast",
    },
...
function cloudlan() {
    ...
    return (
        <Layout
            ...
            <header className={clsx('hero hero--primary', styles.heroBanner)}>
                <div className="container">
                    <h1 className="hero__title">{"Simply5 CloudLAN"}</h1>
                    ...
                    <div className={styles.buttons}>
                        <Link
                            ...
                            to={useBaseUrl('docs/cloudlan/getting_started/introduction/')}>
                            Get Started
                        </Link>
                    </div>
                </div>
