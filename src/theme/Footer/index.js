    ...
    <div className={styles.Column}>
      ...
      <div className={styles.Row}>
        <a
          ...
          href="https://www.facebook.com/simply5.io"
          target="_blank"
          title="Facebook"
        >
          <Facebook fill width="24" height="24" />
        </a>
        <a
          className={styles.Link}
          href="https://www.facebook.com/simply5.io"
          ...
          title="Facebook"
        >
          <Twitter fill width="24" height="24" />
        </a>
        <a
          className={styles.Link}
          href="https://www.facebook.com/simply5.io"
          ...
          title="Facebook"
        >
          <MailIcon fill width="24" height="24" />
        </a>
        <a
          className={styles.Link}
          href="https://www.facebook.com/simply5.io"
          ...
          title="Facebook"
        >
          <Youtube fill width="24" height="24" />
        </a>
      </div>
    </div>
    <div className={styles.Column}>
